...
class RecipeModelTest(TestCase):
    ...
    def test_recipeingredients_verbose_name(self):
        ...
        for value, expected in field_verbose.items():
            with self.subTest(value=value):
                self.assertEqual(
                    recipeingredients._meta.get_field(value).verbose_name,
                    expected,
                )
    ...
    def test_purchase_verbose_name(self):
        ...
        for value, expected in field_verbose.items():
            with self.subTest(value=value):
                self.assertEqual(
                    purchase._meta.get_field(value).verbose_name,
                    expected,
                )
    ...
    def test_recipeingredients_name(self):
        ...
        self.assertEquals(expected_object_name, str(recipeingredients))
    ...
    def test_purchase_name(self):
        ...
        expected_object_name = (f'{purchase.user} add to purchase '
                                f'{purchase.recipe}')
        self.assertEquals(expected_object_name, str(purchase))
